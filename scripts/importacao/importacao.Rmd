...
<img class = "logo_company" src = "`r file.path(pasta$superior, '_common', 'images', 'company.png')`" />
<img class = "logo_department" src = "`r file.path(pasta$superior, '_common', 'images', 'department.png')`" />
...
:::: {.logo_e_data}
<img src = "`r file.path(pasta$superior, '_common', 'images', 'department.png')`" />
